...
export const Header = () => {
  return (
    <div className="max-w-7xl relative mx-auto py-20 md:py-40 px-4 w-full left-0 top-0">
      ...
      <p className="max-w-2xl text-base md:text-xl mt-8 dark:text-neutral-200 font-space-grotesk">
        Software Developer with expertise in React.js, Node.js, and full-stack development. 
    ...
    >
      ...
      >
        <Image
          ...
          height="600"
          width="600"
          className="object-fit object-center absolute h-full w-full inset-0"
          alt={product.title}
        />
      </Link>
      <div className="absolute inset-0 h-full w-full opacity-0 group-hover/product:opacity-80 bg-black pointer-events-none"></div>
      <h2 className="absolute bottom-4 left-4 opacity-0 group-hover/product:opacity-100 text-white font-space-grotesk font-medium">
        {product.title}
      </h2>
    </motion.div>
  );
